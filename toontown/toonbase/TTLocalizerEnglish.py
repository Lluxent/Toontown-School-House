...
MovieNPCSOSToonsHit = 'Toons Always Hit for %s Round%s!'
MovieNPCSOSCogsMiss = 'Cogs Always Miss for %s Round%s!'
...
SuitAttackTaunts = {
 ...
 'CigarSmoke': ['You can\'t even escape my secondhand smoke.',
            'Gentlemen.',
            'Breathe it all in.',
 ...
 'SongAndDance': ['Whoa-oh-oh-oh!',
          'And I call this one \'The Cog Shake.\'',
          'It really is nothing more than a business technique.',
          'Doing it better than you ever could.'],
 ...
 'ThrowBook': ['If you\'re going to play, play by the rules.',
            'Legally speaking, you couldn\'t possibly understand.',
...
InventoryAffectsOneCog = 'Target: One ' + Cog
InventoryAffectsOneToon = 'Target: One Toon'
InventoryAffectsAllToons = 'Target: All Toons'
InventoryAffectsAllCogs = 'Target: All ' + Cogs
...
SuitInvasionBeginSkele = lToonHQ + ': A Skelecog Cog Invasion has begun!!!'
SuitInvasionBeginExec = lToonHQ + ': An Executive Cog Invasion has begun!!!'
SuitInvasionBeginBoth = lToonHQ + ': An Executive Skelecog Cog Invasion has begun!!!'
...
SuitInvasionBulletinSkele = lToonHQ + ': Skelecog %s have taken over Toontown!!!'
SuitInvasionBulletinExec = lToonHQ + ': Executive %s have taken over Toontown!!!'
SuitInvasionBulletinBoth = lToonHQ + ': Executive Skelecog %s have taken over Toontown!!!'
...
NPCToonNames = {20000: 'Tutorial Tom',
 ...
 7800: 'Flip',
 7801: 'Flop',
 7802: 'Shopkeeper Sally',
}
zone2TitleDict = {2000: (lToontownCentral + ' Playground', 'the '),
 2513: ('Toon Hall', ''),
 2514: ('Toontown Bank', ''),
