...
class SuitInvasionManagerAI:
    ...
    def setInvadingCog(self, suitName, skeleton, executive):
        self.invadingCog = (suitName, skeleton, executive)
    ...
    def startInvasion(self, cogType, numCogs, skeleton, executive):
        if self.getInvading():
            return False

        self.numSuits = numCogs
        self.setInvadingCog(cogType, skeleton, executive)
        self.invading = True
