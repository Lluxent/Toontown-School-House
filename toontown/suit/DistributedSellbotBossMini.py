...
class DistributedSellbotBossMini(DistributedMiniboss.DistributedMiniboss, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        if self.doobers:
            self.__doobersToPromotionPosition(self.doobers[:4], self.battleNode)
        ...
        toonTrack = Parallel()
        self.__toonsToPromotionPosition(self.toons, self.battleNode)
        delay = 0
        ...
        dialogTrack = Track(
            ...
            (34, Sequence(
                Func(self.clearChat),
                self.loseCogSuits(self.toons, self.battleNode, (0, 18, 5, -180, 0, 0)))),
            (37, Sequence(
                ...
                Parallel(self.backupToonsToBattlePosition(self.toons, self.battleNode),
                         Sequence(
                             Wait(2),
    ...
    def loadEnvironment(self):
        ...
        self.battleOneMusic = base.loader.loadMusic('phase_9/audio/bgm/raging_waves.ogg')
    ...
    def enterBattleThree(self):
        DistributedMiniboss.DistributedMiniboss.enterBattleThree(self)
        self.clearChat()
        self.cagedToon.clearChat()
        self.reparentTo(render)
        self.rampA.request('retract')
    ...
    def exitBattleThree(self):
        DistributedMiniboss.DistributedMiniboss.exitBattleThree(self)
        bossDoneEventName = self.uniqueName('DestroyedBoss')
