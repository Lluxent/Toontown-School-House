...
rb = (('glower', 'glower', 5), ('magic1', 'magic1', 5), ('golf-club-swing', 'golf-club-swing', 5), ('magic3' ,'magic3', 5), ('pickpocket', 'pickpocket', 5), ('cigar-smoke', 'cigar-smoke', 5))
...
class Suit(Avatar.Avatar):
    ...
    def generateSuit(self):
        ...
        if dna.name == 'f':
            ...
            self.handColor = VBase4(0.1, 0.1, 0.1, 1.0)
            self.headColor = VBase4(0.1, 0.1, 0.1, 1.0)
            self.generateBody()
            self.generateHead('flunky')
            self.setHeight(3.0)
        elif dna.name == 'hst':
