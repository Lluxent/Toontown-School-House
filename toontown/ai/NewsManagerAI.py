...
class NewsManagerAI(DistributedObjectAI):
    ...
    def d_setInvasionStatus(self, msgType, cogType, numRemaining, skeleton, executive):
        self.sendUpdate('setInvasionStatus', [msgType, cogType, numRemaining, skeleton, executive])
