...
from toontown.building import DistributedDoorAI, DistributedRenegadeElevatorAI
from toontown.building import DoorTypes
from toontown.coghq import LobbyManagerAI
from toontown.building import DistributedBossElevatorAI
from toontown.suit import DistributedBossbotBossAI, DistributedRenegadeMinibossAI
...
class BossbotHQDataAI(HoodDataAI.HoodDataAI):
    ...
    def startup(self):
        ...
        self.renMgr = LobbyManagerAI.LobbyManagerAI(self.air, DistributedRenegadeMinibossAI.DistributedRenegadeMinibossAI)
        self.renMgr.generateWithRequired(ToontownGlobals.BossbotLobby)
        self.addDistObj(self.renMgr)
        self.renegadeElevator = DistributedRenegadeElevatorAI.DistributedRenegadeElevatorAI(self.air, self.renMgr, ToontownGlobals.BossbotLobby, antiShuffle = 0)
        self.renegadeElevator.generateWithRequired(ToontownGlobals.BossbotLobby)
        self.addDistObj(self.renMgr)
